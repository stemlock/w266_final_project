...
def gender_mapping(f_vocab, m_vocab, f_names, m_names):
    ...
    # For each word in the female name list, create a mapping to the most common male name
    for name in f_names:
        f_mapping[name] = ['james']
    ...
    # For each word in the male name list, create a mapping to the most common female name
    for name in m_names:
        m_mapping[name] = ['mary']
